...
const new_BossContent_data: I_BossContent[] = [
    {Id: "boss01", Name: "자쿰", Rank: ["카오스"]},
    {Id: "boss02", Name: "매그너스", Rank: ["하드"]},
    {Id: "boss03", Name: "힐라", Rank: ["하드"]},
    {Id: "boss04", Name: "파풀라투스", Rank: ["카오스"]},
    {Id: "boss05", Name: "피에르", Rank: ["카오스"]},
    {Id: "boss06", Name: "반반", Rank: ["카오스"]},
    {Id: "boss07", Name: "블러디퀸", Rank: ["카오스"]},
    {Id: "boss08", Name: "벨룸", Rank: ["카오스"]},
    {Id: "boss09", Name: "핑크빈", Rank: ["카오스"]},
    {Id: "boss10", Name: "시그너스", Rank: ["이지", "노멀"]},
    ...
    {Id: "boss17", Name: "진 힐라", Rank: ["노멀", "하드"]},
    {Id: "boss18", Name: "듄켈", Rank: ["노멀", "하드"]},
    {Id: "boss19", Name: "선택받은 세렌", Rank: ["노멀", "하드", "익스트림"]},
    {Id: "boss20", Name: "감시자 칼로스", Rank: ["이지", "노멀", "카오스", "익스트림"]},
    {Id: "boss21", Name: "최초의 대적자", Rank: ["이지", "노멀", "하드", "익스트림"]},
    {Id: "boss22", Name: "카링", Rank: ["이지", "노멀", "하드", "익스트림"]},
    {Id: "boss23", Name: "찬란한 흉성", Rank: ["노멀", "하드"]},
    {Id: "boss24", Name: "림보", Rank: ["노멀", "하드"]},
    {Id: "boss25", Name: "발드릭스", Rank: ["노멀", "하드"]},
    {Id: "boss30", Name: "검은 마법사", Rank: ["하드", "익스트림"]},
];
